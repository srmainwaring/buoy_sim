...
BuoyancyForces(3) = this->m_rho*this->m_grav*(this->Vol*this->COB(1)-(this->Vol*this->COB(2)+this->S22)*x(3)+this->Vol*COB(0)*x(5)); //Roll
BuoyancyForces(4) = this->m_rho*this->m_grav*(-this->Vol*this->COB(0)-(this->Vol*this->COB(2)+this->S11)*x(4)+this->Vol*COB(1)*x(5));  //Pitch
